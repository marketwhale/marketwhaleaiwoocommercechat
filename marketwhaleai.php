...
function mwai_enqueue_assets() {
	...
	wp_enqueue_style( 'mwai-style', $plugin_url . 'assets/css/style.css', array(), '1.2' );
	wp_enqueue_script( 'mwai-js', $plugin_url . 'assets/js/chat-widget.js', array( 'jquery' ), '1.2', true );
